...
public class DataPlotter : MonoBehaviour
{
    ...
    public string inputfile = Application.dataPath + "/iris";
    ...
    void Start()
    {
        ...
        for (var i = 0; i < pointList.Count; i++)
        {
            ...
            GameObject dataPoint = Instantiate(PointPrefab, new Vector2(x, y), Quaternion.identity);
            if (z == 1)
