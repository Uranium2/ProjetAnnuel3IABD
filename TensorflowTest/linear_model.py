...
def linear_keras(img_per_folder, height, width, imageToPredict, batch_size=1, epochs=500, FPS_model=None, MOBA_model=None, RTS_model=None,):
	...
	if (FPS_model is None or MOBA_model is None or RTS_model is None):
		#create models
		W_FPS = Sequential()
...
FPS_model = load_linear_model("models/FPS_model")
MOBA_model = load_linear_model("models/MOBA_model")
RTS_model = load_linear_model("models/RTS_model")
print(linear_keras(50, 20, 20, "../img/RTS_Test/RTS_0140.png", 1, 500, FPS_model, MOBA_model, RTS_model))